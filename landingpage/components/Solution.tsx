      ...
      <div className="container mx-auto px-6">
        <div className="mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-2xl">
            Não é mágica, é engenharia de contexto. Nossa pipeline transforma repositórios opacos em mapas cristalinos para IA.
          </p>
        </div>
        ...
        >
          <div className="bg-brand-black rounded-xl p-8 md:p-12 text-center">
            ...
            <p className="text-lg text-gray-300">
              Sua IA agora <span className="text-brand-primary font-bold">sabe</span> que você usa Repository Pattern e não vai tentar injetar SQL direto na View.
            </p>
          </div>
        </motion.div>
      </div>
