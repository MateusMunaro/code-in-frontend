        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-sm mb-6">
              Inteligência de arquitetura para equipes que não aceitam código ruim. O padrão de Tech Lead para suas ferramentas de IA.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-brand-primary">Integrações</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li><a href="#" className="hover:text-brand-primary">Sobre</a></li>
