    ...
    <section className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center z-10">
        ...
        >
          ...
          <span className="text-sm font-medium text-gray-300">Nova Integração com Cursor & Copilot</span>
        </motion.div>
        ...
        >
          O <span className="text-brand-primary">Tech Lead</span> para as<br />
        ...
        >
          Transforme IAs "Júnior" em Engenheiros Sênior. Analisamos a arquitetura profunda do seu repositório para gerar contextos perfeitos, não apenas código sintático.
        </motion.p>
        ...
        >
          <Button size="lg" icon={ArrowRight}>Analisar meu Repo Agora</Button>
          <Button variant="outline" size="lg" icon={Code2}>Ver Demonstração</Button>
        </motion.div>
