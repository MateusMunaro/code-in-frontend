...
export const ROI: React.FC = () => {
  ...
  const [rate, setRate] = useState(50); // Hourly rate in USD
  
  // Assumptions:
  // - Devs waste 20% of time explaining context to AI or fixing AI errors.
  // - 160 hours per month.
  // - Code-in saves 75% of that wasted time.
  const hoursPerMonth = 160;
  const wastedTimePercentage = 0.20;
  const recoveryRate = 0.75;
  
  const savedMonthly = Math.round(devs * hoursPerMonth * rate * wastedTimePercentage * recoveryRate);
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-8 text-lg">
              Quanto sua empresa gasta enquanto devs seniores corrigem código de IA ou explicam a arquitetura repetidamente?
            </p>
          ...
          >
            <h3 className="text-xl font-bold text-white mb-8 border-b border-white/10 pb-4">Calculadora de ROI</h3>
            
            <div className="space-y-8">
              <div>
                <div className="flex justify-between mb-2">
                  <label className="text-sm font-medium text-gray-400">Tamanho da Equipe</label>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <label className="text-sm font-medium text-gray-400">Custo Hora Médio (USD)</label>
              ...
              <div className="bg-brand-black/50 p-6 rounded-xl border border-brand-primary/20">
                <div className="text-center">
                  <p className="text-sm text-gray-400 mb-1">Economia Projetada (Ano)</p>
