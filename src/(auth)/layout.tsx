...
function AuthLayoutContent() {
    ...
    return (
        <div className="min-h-screen flex w-full" style={{ backgroundColor: colors.background.content }}>
            {/* Scanlines Overlay */}
            ...
            {/* Main Content */}
            <div
                className={`flex-1 flex flex-col min-h-screen max-w-full overflow-x-hidden transition-all duration-300 relative z-10 ${isCollapsed ? 'lg:ml-20' : 'lg:ml-64'
                    }`}
            >
                <Header />
